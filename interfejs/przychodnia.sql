...
--
-- Host: 127.0.0.1
-- Czas generowania: 23 Sty 2022, 14:14
...
(8, 'Michał', 'Anioł', 'M', '123876543', 'michal@gmail.com', '55121209876', '0000-00-00', 11, 'michael', 'angelo'),
(9, 'Maria', 'Rokita', 'K', '958475233', '', '72150198765', '0000-00-00', 12, 'mrokita72', 'koronapany'),
...
--
ALTER TABLE `badania`
  MODIFY `ID_badania` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT dla tabeli `choroby`
--
ALTER TABLE `choroby`
  MODIFY `ID_choroby` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
