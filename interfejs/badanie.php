...
<body>
    ...
    <div id="con">
        ...
        <form class="formularz" id="dodaj_badanie" method="post" action="dodaj_badanie.php">
        <br>
        <input name="d_koszt" placeholder="Koszt" required><br>
        <input name="d_opis" placeholder="Opis" required><br>
        <input name="d_ip" placeholder="ID_pacjenta" required><br>
        <input name="d_iw" placeholder="ID_wystawiającego" required><br>
        
        
        <input class="submit_form" type="submit" name="wyslij" value="Dodaj badanie"><br>
