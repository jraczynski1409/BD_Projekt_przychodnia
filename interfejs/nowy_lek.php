...
<body>
    ...
    <div id="con">
        ...
        <form class="formularz" id="dodaj_prac" method="post" action="dodaj_lek.php">
        <br>
        <input name="d_nazwa" placeholder="Nazwa" required><br>
        <input name="d_cena" placeholder="Cena" required><br>
        
        
        <input class="submit_form" type="submit" name="wyslij" value="Dodaj lek"><br>
