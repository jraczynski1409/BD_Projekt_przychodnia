...
<body>
    ...
    <div id="con">
        <h1>Informacje o badaniach</h1>
        <?php
           require_once "connect.php";
        
            $polaczenie = @new mysqli($host, $db_u, $db_p, $db_n);
        
            $zapytanie = "SELECT * from info_badania";
            
            $result=mysqli_query($polaczenie,$zapytanie);
            
            echo "<table class='tabela'>";
            
             echo "<tr class='naglowek_tabeli'><td>ID</td><td>PESEL</td><td>Imie_pacjenta</td><td>Nazwisko_pacjenta</td><td>Opis</td><td>Koszt</td><td>ID_recepty</td><td>Imie_wystaw.</td><td>Nazwisko_wystaw.</td></tr>";
            
            while($row = mysqli_fetch_row($result))
            {
                echo "<tr><td>".$row[3]."</td>"."<td>".$row[0]."</td>"."<td>".$row[1]."<td>".$row[2]."</td>"."<td>".$row[5]."</td>"."<td>".$row[4]."</td>"."<td>".$row[8]."</td>"."<td>".$row[6]."</td>"."<td>".$row[7]."</td>"."</tr>";
            }
            echo "</table>"
        ?>
        </div>
