    ...
    <div id="con">
        ...
        <?php
           require_once "connect.php";
            ...
            $zapytanie = "SELECT * from info_pracownicy";
            
            $result=mysqli_query($polaczenie,$zapytanie);
            
            echo "<table id='tabprac' class='tabela'>";
            
             echo "<tr class='naglowek_tabeli'><td>ID</td><td>Imię</td><td>Nazwisko</td><td>Płeć</td><td>Telefon</td><td>Email</td><td>PESEL</td><td>Data urodzenia</td><td>Przychodnia</td><td>Pensja</td><td>Stanowisko</td><td>Data zatrudnienia</td><td>Koniec umowy</td><td>Miasto</td><td>Kod pocztowy</td><td>Ulica</td><td>Nr budynku</td><td>Nr mieszkania</td></tr>";
            
            while($row = mysqli_fetch_row($result))
            {
                echo "<tr><td>".$row[0]."</td>"."<td>".$row[1]."</td>"."<td>".$row[2]."</td>"."<td>".$row[3]."</td>"."<td>".$row[4]."</td>"."<td>".$row[5]."</td>"."<td>".$row[6]."</td>"."<td>".$row[7]."</td>"."<td>".$row[8]."</td>"."<td>".$row[9]."</td>"."<td>".$row[10]."</td>"."<td>".$row[11]."</td>"."<td>".$row[12]."</td>"."<td>".$row[15]."</td>"."<td>".$row[16]."</td>"."<td>".$row[17]."</td>"."<td>".$row[18]."</td>"."<td>".$row[19]."</td>"."</tr>";
            }
            echo "</table>"
        ?>
        </div>
