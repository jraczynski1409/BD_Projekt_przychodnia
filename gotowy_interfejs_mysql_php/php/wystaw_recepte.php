...
<body>
    ...
    <div id="con">
        ...
        <form class="formularz" id="dodaj_prac" method="post" action="dodaj_recepte.php">
        <br>
        <input name="d_leku" placeholder="id_leku" required><br>
        <input name="id_badania" placeholder="id_badania" required><br>
