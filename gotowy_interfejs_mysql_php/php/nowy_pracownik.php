...
<body>
    ...
    <div id="con">
        ...
        <form class="formularz" id="dodaj_prac" method="post" action="dodaj_prac.php">
        DANE OSOBOWE:<br>
        ...
        <br><br>UMOWA:<br>
        <input name="d_du" type='date'required><br>
        <input type="number" name="d_pensja" placeholder="Pensja" required><br>   
        <input type="radio" name="d_stan" value=1 required>Pielegniarz
        <input type="radio" name="d_stan" value=2>Pediatra
        <input type="radio" name="d_stan" value=3>Stomatolog 
        <input type="radio" name="d_stan" value=4>Kadiolog 
        <input type="radio" name="d_stan" value=5>Dietetyk 
        <input type="radio" name="d_stan" value=6>Neurolog <br>
        <input type="radio" name="d_stan" value=7>Okulista 
        <input type="radio" name="d_stan" value=8>Chemik/Laborant 
        <input type="radio" name="d_stan" value=9>Endokrynolog 
        <input type="radio" name="d_stan" value=10>Ginekolog 
        <input type="radio" name="d_stan" value=11>Urolog <br><br>
        <input type="radio" name="d_prz" value=1 required>Przychodnia nr1
        <input type="radio" name="d_prz" value=2>Przychodnia nr2 
        <input type="radio" name="d_prz" value=3>Przychodnia nr3 <br>
