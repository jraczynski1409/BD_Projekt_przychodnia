...
require_once "connect.php";
	...
	else
	{
        ...
        $insert_pracownik="insert into pracownicy values (NULL,CURRENT_DATE(),$d_du,$d_pensja,$d_stan,(SELECT LAST_INSERT_ID()),$d_prz)";
        
        
        if((mysqli_query($polaczenie, $insert_adresy))&&(mysqli_query($polaczenie, $insert_osoby))&&(mysqli_query($polaczenie, $insert_pracownik)))
        {
